...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const casesData = {
    case1: {
      ...
      Исходные данные: 
      • Площадь: 119 м² 
      • Частичная отделка: покрашенныестены, плитка в санузле У заказчиков была частично своямебель и декор.
      
      Процесс работы: 
      • Комплектация: выбрали необходимыематериалы и мебель.
      • Полная отделка санузла с покраскойстени установкой сантехники.
      • Финальный хоумстейджинг:создали атмосферу уюта и комфорта.
      ...
      • Выше среднерыночной цены на 10% Конкуренция: несколько аналогичныхобъектов в районе. 
      • Наша цена на уровне рынка, но качествои оформление сделали свое дело!
      `
    },
    ...
    case2: {
      ...
      Процесс работы: 
      • Полная комплектация и финальный хоумстейджинг завершены за 3 месяца. 
    ...
    case3: {
      ...
      Процесс работы: 
      • Полная комплектация и финальный хоумстейджинг завершены за 2 месяца. 
      ...
      Сдается на 15% выше чем конкуренты. Конкуренция очень высока
      `
    },
    ...
    case4: {
      ...
      beforeText: `
      Бюджет - минимальный. Расходы собственника составили примерно 12 800 руб. на краску и работу по перекраске. 
